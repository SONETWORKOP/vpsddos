...
bot_token = '7501830640:AAGgDQiXnt039INPY8VFu8VMpHVts8fufbU'  # Replace with your bot token
...
ADMIN_ID = 6245798111  # Replace with the actual admin's user ID
...
def handle_contact_admin(message):
    bot.reply_to(message, f"📞 @ShivamVerified: {ADMIN_ID}")

def handle_generate_key(message):
    if message.from_user.id == 6245798111:
